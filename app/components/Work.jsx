...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12'> Welcome to my web development portfolio! 
    ...
    className='grid lg:grid-cols-4 my-10 gap-5 dark:text-black'>
        {workData.map((project, index)=>(
            ...
            style={{backgroundImage: `url(${isDarkMode ? project.bgImageDark : project.bgImage})`}}>
                <div className='bg-[#ffc599] w-10/12 rounded-md absolute bottom-5 
    ...
    href="https://github.com/JeniwaD" className='w-max flex items-center justify-center gap-2
