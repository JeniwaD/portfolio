...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "342f6ccb-1e38-4e7b-9791-08c7c7f981b5");
  ...
  return (
    ...
    bg-no-repeat bg-center bg-[-length:90%_auto] dark:bg-none'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12'> I'd love to
            hear from you! If you have any questions, comments, or feedback, 
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            <div className='grid lg:grid-cols-2 gap-6 mt-10 mb-8'>
            ...
            row="6" placeholder='Enter your message' required
