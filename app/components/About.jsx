...
>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='flex-1'>
                ...
                >I am an aspiring Frontend Developer with a strong passion 
                for building responsive and user-friendly web interfaces, 
                developed through hands-on personal projects.A fast learner 
                with a growth mindset, I am eager to contribute, continuously 
                improve my skills, and create engaging digital experiences.</p>
                ...
                className='my-6 text-gray-700 dark:text-white/80'>Tool I use
                </motion.h4>
