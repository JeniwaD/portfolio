...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    flex items-center justify-between z-50 ${isScroll ? "bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        ...
        rounded-full px-12 py-3 ${isScroll ? "":"bg-white shadow-sm dark:bg-transparent dark:border dark:border-white/50"}`} >
        ...
        <div className='flex items-center gap-4'>
            ...
            py-2.5 border border-gray-500 rounded-full ml-4 dark:border-white/50'>Contact 
